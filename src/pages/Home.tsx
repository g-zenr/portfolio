...
const Home: React.FC<HomeProps> = ({ id }) => {
  return (
    <section
      id={id}
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-gray-100 pt-20"
    >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="md:w-1/2 space-y-6 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <a
                href="#contact"
                className="px-6 py-3 border-2 border-gray-300 text-gray-800 rounded-lg font-medium hover:border-blue-600 hover:text-blue-600 transition"
              >
                Contact Me
              </a>
            </div>
            ...
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full bg-gradient-to-r from-blue-400 to-blue-600 shadow-2xl p-1">
                <div className="w-full h-full rounded-full bg-white overflow-hidden">
                  ...
                  <div className="w-full h-full bg-gray-200 flex items-center justify-center text-gray-600 text-4xl">
                    Your Photo
                  </div>
                </div>
              </div>
              ...
              {/* Decorative elements */}
              <div className="absolute top-0 -right-8 w-32 h-32 bg-blue-100 rounded-full opacity-60 -z-10"></div>
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-blue-200 rounded-full opacity-60 -z-10"></div>
            </div>
          </div>
        </div>
      </div>
